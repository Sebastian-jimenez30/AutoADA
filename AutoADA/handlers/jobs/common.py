...
def _mods():
    return {'importar': 'scripts.importar_all', 'convertir': 'scripts.Convertir_all', 'scan_data': 'scripts.scan_data', 'scada_sa': 'scripts.SCADA_S-A', 'eliminar': 'scripts.eliminar_senales_scada', 'cambiar_nombre': 'scripts.cambiar_nombre_senales_scada'}
