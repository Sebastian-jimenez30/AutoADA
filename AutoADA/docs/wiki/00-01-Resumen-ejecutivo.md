...
Automatismo ADA (AutoADA) es una aplicación de escritorio que **automatiza y estandariza** tareas operativas críticas del equipo DOT Intercolombia, principalmente sobre:
...
En términos generales, AutoADA se organiza en capas:
...
AutoADA no reemplaza sistemas como SCADA, HSH o HIS; en cambio, se posiciona como una **capa de automatización** que:
...
Esta separación permite evolucionar AutoADA sin modificar los sistemas fuente, y viceversa.
