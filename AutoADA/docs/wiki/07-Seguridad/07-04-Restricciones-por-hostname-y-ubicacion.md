...
AutoADA no está pensado para ejecutarse en cualquier equipo: aplica restricciones basadas en el **hostname** de la máquina para determinar la “ubicación” y ajustar qué se permite.
...
Esto evita que AutoADA se ejecute “normalmente” en equipos desconocidos.
...
Estas restricciones ayudan a asegurar que AutoADA solo se use en entornos controlados y con la configuración adecuada.
