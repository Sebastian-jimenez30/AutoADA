...
Esta página resume las **variables de entorno** que AutoADA carga a partir del vault y cómo las utilizan los scripts CLI.

---

## ¿Por qué usar variables de entorno?

En lugar de que los scripts lean directamente el vault o archivos con secretos, AutoADA:
...
- Estas variables existen mientras se ejecuta AutoADA y sus subprocesos.
