...
AutoADA utiliza certificados y llaves para establecer **conexiones seguras** (TLS/SSH) con sistemas externos, especialmente Mongo (HSH) y servidores remotos accesibles por SSH.
...
La seguridad de las conexiones TLS/SSH depende tanto del código como de la infraestructura y políticas externas; AutoADA aporta su parte gestionando bien estos archivos dentro de su ámbito.
