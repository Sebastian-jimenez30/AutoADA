...
- `out/` y `log/` viven junto al ejecutable (`AutoADA.exe`) o al proyecto en modo desarrollo.
...
Entender esta estructura te ayuda a encontrar rápidamente los archivos que necesitas y a mantener el entorno de AutoADA limpio y manejable.
