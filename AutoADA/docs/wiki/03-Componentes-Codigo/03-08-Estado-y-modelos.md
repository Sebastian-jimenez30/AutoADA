...
Actualmente, AutoADA utiliza un modelo de estado relativamente simple, pero está preparado para crecer con nuevas necesidades. Esta página describe el estado global y posibles evoluciones.
