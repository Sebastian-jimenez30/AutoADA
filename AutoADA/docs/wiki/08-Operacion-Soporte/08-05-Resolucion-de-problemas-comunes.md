...
Esta página recopila errores frecuentes en AutoADA y cómo abordarlos antes de escalar al equipo de desarrollo.
...
## 7. AutoADA “se cuelga” o tarda demasiado
...
- Verificar:
  - Que el exe se generó con las especificaciones actualizadas (`AutoADAITCO.spec`, `AutoADAREP.spec`).
