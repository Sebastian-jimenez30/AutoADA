...
Este checklist sugiere qué revisar al inicio de la jornada o antes de ejecutar procesos importantes en AutoADA.

---

## Antes de iniciar AutoADA
...
## Al iniciar sesión en AutoADA

1. Abrir AutoADA (exe o `python main.py` en dev).
