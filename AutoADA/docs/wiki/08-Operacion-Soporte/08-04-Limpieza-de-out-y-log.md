...
Con el tiempo, las carpetas `out/` y `log/` pueden acumular muchos archivos. Esta página explica cómo limpiarlas sin afectar el funcionamiento de AutoADA.
...
- `log/`:
  - AutoADA volverá a crear la carpeta y nuevos logs al ejecutar scripts.
...
Una gestión cuidadosa de `out/` y `log/` mantiene AutoADA ágil y evita problemas de espacio sin sacrificar trazabilidad.
