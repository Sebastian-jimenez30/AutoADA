...
Esta página describe qué ocurre desde que el usuario ejecuta AutoADA hasta que se muestra la pantalla de bienvenida, incluyendo el manejo de la CLI y el login con vault.
...
Al iniciar, AutoADA verifica si fue invocado en modo “dispatcher de scripts”:
...
Con esto se busca evitar el uso de AutoADA en entornos no autorizados.
...
El flujo de arranque queda completo, y AutoADA entra en su ciclo normal de operación.
