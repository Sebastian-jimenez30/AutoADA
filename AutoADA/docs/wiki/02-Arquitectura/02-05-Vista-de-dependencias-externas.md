...
AutoADA interactúa con varios **sistemas y librerías externas**. Esta página resume cuáles son, para qué se usan y cómo se integran.
...
Los archivos de especificación (`AutoADAITCO.spec`, `AutoADAREP.spec`) se encargan de:
...
AutoADA se apoya en un conjunto de sistemas y librerías externas para:
...
- Evaluar impactos de cambios en la infraestructura sobre AutoADA.
