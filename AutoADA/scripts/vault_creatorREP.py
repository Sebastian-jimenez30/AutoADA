...
SCA_HOSTS = ["rep1sca01", "rep1sca02"]
HIS_HOSTS = ["rep1his01", "rep1his02"]
SSH_PORT = 22
...
def _pem_paths() -> Dict[str, str]:
    base_dir = os.path.join(os.path.dirname(__file__), "cifrarREP")
    return {
...
def main() -> None:
    ...
    out_path = os.path.join(os.getcwd(), "REPS.bin")
