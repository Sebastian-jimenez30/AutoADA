...
Son las personas que **usan AutomatizADA en el día a día** para ejecutar tareas relacionadas con:
...
### Desarrollo / Mantenimiento de AutomatizADA
...
- Definen las **prioridades de automatización** (qué procesos llevar a AutomatizADA y en qué orden).
- Evalúan el impacto de la herramienta en los indicadores del área (tiempos de ciclo, errores, retrabajos).
- Aseguran que AutomatizADA se alinee con las **políticas de seguridad y cumplimiento** de la organización.
...
- Liderazgo técnico define prioridades y asegura que AutomatizADA siga siendo relevante y sostenible.
