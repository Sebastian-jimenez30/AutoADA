# 01-03 – Flujos antes y después de AutomatizADA

Esta sección compara cómo se realizaban las tareas clave **antes** de AutomatizADA y cómo se realizan **después**, resaltando los cambios en:
...
## Situación previa (antes de AutomatizADA)
...
## Situación actual (con AutomatizADA)

Con AutomatizADA, la ejecución de estos procesos se centraliza en una **aplicación de escritorio con UI unificada**:
...
Al pasar de flujos manuales dispersos a flujos centralizados en AutomatizADA, se espera:
