...
Esta sección resume los requisitos que guían el diseño de AutomatizADA desde el punto de vista del negocio y de la operación. No pretende ser un pliego formal, sino una referencia práctica.
...
4. **Seguridad**
   ...
   - RNF-10: El acceso a AutomatizADA debe restringirse a equipos autorizados (control por hostname).
...
- Comunicar de forma clara qué se espera de AutomatizADA a nivel funcional y operativo.
