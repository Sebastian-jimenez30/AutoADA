...
AutomatizADA usa un **vault cifrado** para almacenar credenciales y parámetros sensibles. Esta página explica cómo funciona ese vault y cómo se derivan las claves.
...
El vault es el corazón del manejo de credenciales en AutomatizADA; protegerlo adecuadamente es fundamental.
