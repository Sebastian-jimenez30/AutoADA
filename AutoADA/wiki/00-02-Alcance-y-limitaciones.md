...
AutomatizADA cubre los siguientes procesos de manera integrada:
...
## Lo que AutomatizADA **no** es

Para evitar malentendidos, AutomatizADA **no**:
...
- **Trazabilidad externa**:
  - Los logs son locales a la máquina; si se requiere centralización/logging corporativo, debe implementarse fuera de AutomatizADA.

## Responsabilidades compartidas

La automatización que aporta AutomatizADA debe complementarse con:
