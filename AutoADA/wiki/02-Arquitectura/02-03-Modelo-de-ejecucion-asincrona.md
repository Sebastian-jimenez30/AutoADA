...
AutomatizADA ejecuta procesos pesados (importar, convertir, validar, generar reportes) como **subprocesos** externos para no bloquear la interfaz Tkinter. Esta página explica cómo está diseñado ese modelo.
...
Este modelo es un pilar clave de la arquitectura de AutomatizADA, ya que la mayoría de funcionalidades dependen de scripts intensivos.
