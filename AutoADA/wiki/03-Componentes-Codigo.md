...
Esta sección baja un nivel respecto a *Arquitectura global* y describe **cómo se organiza el código fuente** de AutomatizADA:
...
Está pensada para personas que van a **mantener o extender** AutomatizADA (desarrollo, soporte avanzado).
