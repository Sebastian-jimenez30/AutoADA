# Automatismo ADA (AutomatizADA) – Portada

Bienvenida a la documentación del **Automatismo ADA (AutomatizADA)**, una aplicación de escritorio desarrollada para el equipo DOT Intercolombia que centraliza y automatiza tareas operativas sobre datos SCADA, HSH, ODS, pruebas PyP y consultas a RTU/SAS.
...
AutomatizADA es una herramienta desktop (Python/Tkinter) que:
...
En términos simples: AutomatizADA reduce el error humano, acelera tareas repetitivas y estandariza la generación de artefactos críticos para la operación.
...
- **Desarrolladores/as** que mantienen o extienden AutomatizADA, y necesitan conocer la arquitectura, componentes y procesos de build.
