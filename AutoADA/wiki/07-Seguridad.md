...
Esta sección describe cómo AutomatizADA maneja **seguridad, credenciales y accesos**:
...
  Visión general de la seguridad en AutomatizADA y sus capas (UI, servicios, scripts).
