...
El archivo `config/servers.json` define los **servidores remotos** asociados a cada combinación de empresa y dominio. Es clave para que AutomatizADA sepa a qué host conectarse al importar datos.
