...
Esta página describe los componentes que se ejecutan primero al iniciar AutomatizADA y cómo se diferencia el modo GUI del modo “dispatcher de scripts”.
...
1. Usuario ejecuta `AutomatizADA.exe` o `python main.py`.
2. `main.py`:
