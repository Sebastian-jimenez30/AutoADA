...
La carpeta `utils/` y el módulo `util.py` agrupan funciones y clases de apoyo que se usan en múltiples partes de AutomatizADA. Esta página resume las más importantes.
