...
Los scripts en `scripts/` implementan la mayor parte de la **lógica pesada** de AutomatizADA: importan datos, los convierten, ejecutan validaciones y generan reportes. Esta página resume los más relevantes.
...
Para extender AutomatizADA con nuevos pipelines, lo habitual es:
