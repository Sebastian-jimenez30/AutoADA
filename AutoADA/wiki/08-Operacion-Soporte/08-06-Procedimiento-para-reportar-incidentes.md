...
Cuando AutomatizADA presenta problemas que no puedes resolver con las guías de esta wiki, es importante **reportarlos correctamente** para que el equipo de soporte/desarrollo pueda ayudar de forma eficiente.
...
- Información del entorno:
  ...
  - Equipo (hostname).
  - Versión de AutomatizADA (si se expone en la UI o documentación de despliegue).
...
- Usar un asunto/título descriptivo:
  - “AutomatizADA – Error al validar HSH en ITCO – 2025-11-15”
...
- Registrar (en el ticket o documentación interna):
  ...
  - Versión de AutomatizADA donde quedó solucionado (si aplica).
...
Un buen reporte de incidentes es parte clave del mantenimiento sano de AutomatizADA en el tiempo.***
