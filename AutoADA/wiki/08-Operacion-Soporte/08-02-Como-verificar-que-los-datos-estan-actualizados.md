...
Muchas funcionalidades de AutomatizADA dependen de que los datos locales (SCADA, HSH, ODSTXT) estén **recentes**. Esta página resume cómo comprobarlo.
...
Con estos pasos, puedes asegurarte de que AutomatizADA trabaja sobre la información más reciente posible dentro de sus capacidades.***
